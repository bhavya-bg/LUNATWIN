...
st.caption("LUNA16 3D Vision Transformer + Digital Twin + Clinical Intelligence for Pulmonary Nodule Analysis")
...
st.caption("LUNATWIN • app.py • Real model integration attempted")
